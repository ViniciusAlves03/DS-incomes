...
export class EventBusRabbitMQ implements IEventBus {
    private readonly RABBITMQ_QUEUE_NAME: string = 'income'
    private readonly RABBITMQ_RPC_QUEUE_NAME: string = 'income.rpc'
    private readonly RABBITMQ_RPC_EXCHANGE_NAME: string = 'income.rpc'
